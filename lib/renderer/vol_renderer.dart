...
class VolRenderer extends BaseChartRenderer<VolumeEntity> {
  ...
  void drawVerticalText(canvas, textStyle, int gridRows) {
    ...
    tp.paint(
        canvas,
        Offset(chartRect.width - tp.width - style.padding.right,
