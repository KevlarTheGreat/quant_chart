...
class MyHomePageState extends State<MyHomePage> {
  ...
  ChartStyle chartStyle = ChartStyle(
      select: const ChartSelectStyle(
          y: ChartCrossLineStyle(color: Colors.red, length: 20)));
    ...
    return ListView(shrinkWrap: true, children: [
      ...
      if (_bids != null && _asks != null)
        SizedBox(
            ...
            width: double.infinity,
            child: DepthChart(
                bids: _bids!, asks: _asks!, colors: const DepthColors()))
    ]);
  }

  Widget buildButtons() {
    return Wrap(alignment: WrapAlignment.spaceEvenly, children: <Widget>[
  ...
  void getData(String period) {
    /*
    * If you can use a VPN, use method 1 to load data. If you cannot use a VPN,
    * use method 2 to load data. By default, method 1 is used to load the 
    * latest data.
     */
  ...
  // Fetch data from Huobi, VPN required
  ...
  // If you cannot use a VPN, you can use this method to load data
